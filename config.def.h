...
static const char *fonts[]          = { "Roboto:style=Black:size=10" };
static const char dmenufont[]       = "Roboto:style=Black:size=10";
...
static const char *killall[] =  { "pkill dwm", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask|ControlMask, XK_q,      spawn,          {.v = killall } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
